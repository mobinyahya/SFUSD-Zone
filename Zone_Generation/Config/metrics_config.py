...
class MetricSpec:
    ...
    interpretation: str = ""                # Simple, human-readable "how it's calculated + how to interpret" for UI
...
DIVERSITY_METRICS = [
    MetricSpec(
        ...
        is_core=True,
        short_name="Racial",
        interpretation="Measures how closely each zone's racial composition matches the district overall. It is calculated using the Theil Index, an information-theoretic measure commonly used in segregation research that compares each zone's racial distribution to the district-wide distribution. Lower values mean zones mirror the district more closely, while higher values indicate greater racial concentration in certain zones.",
    ...
    MetricSpec(
        ...
        is_core=True,
        short_name="SES",
        interpretation="Measures how evenly students from different income backgrounds are distributed across zones. The score is calculated using a Theil Index based on Free or Reduced-Price Lunch (FRL) eligibility, comparing each zone's share of FRL students to the district average. Lower values indicate a more even distribution of socioeconomic status across zones.",
        chart_type="bar",
        chart_field="frl_pct",
        chart_unit="%",
        chart_max=100,
...
PROXIMITY_METRICS = [
    MetricSpec(
        ...
        interpretation="Estimates how far students typically travel to reach the nearest school in their zone. Distances are computed using geographic distance between student locations and school locations and then averaged across all students in the zone. Lower values mean students generally live closer to an available in-zone school.",
        chart_type="bar",
    ...
    MetricSpec(
        ...
        interpretation="Shows how many in-zone schools are within walking distance of where students live. For each student location, the system counts the number of general-education schools within a 0.5-mile radius and averages this across the zone. Higher values indicate more nearby school options for students.",
        chart_type="bar",
...
PROGRAM_METRICS = [
    ...
    MetricSpec(
        ...
        is_core=True,
        short_name="Seats",
        interpretation="Measures whether the number of school seats matches the number of students living in each zone. It is calculated as the percent difference between student enrollment demand and available general-education seats in that zone. Values near 0% indicate balanced supply and demand, while larger deviations suggest seat shortages or unused capacity.",
        chart_type="bar",
...
QUALITY_METRICS = [
    MetricSpec(
        ...
        is_core=True,
        short_name="Math",
        interpretation="Measures how evenly academic performance is distributed across zones. It calculates the percent deviation of each zone's average math score from the district-wide mean. Smaller deviations indicate more evenly distributed academic outcomes.",
        chart_type="bar",
    ...
    MetricSpec(
        ...
        is_core=True,
        short_name="Eng",
        interpretation="Measures how evenly English performance is distributed across zones. It calculates the percent deviation of each zone's average English score from the district-wide mean. Lower variation between zones indicates more equitable distribution of academic performance.",
        chart_type="bar",
