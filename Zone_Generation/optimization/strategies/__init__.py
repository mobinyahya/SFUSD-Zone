...
actual solving to any :class:`~Zone_Generation.optimization.solvers.base.Solver`.
Single-shot, recursive (coarse->fine) and iterative-choice strategies all
implement the same :class:`~Zone_Generation.optimization.strategies.base.Strategy`
